...
!(function (e, t) {
  ...
  var n,
    ...
    o = {
      ...
      autoHide: !1,
      allowedTags: {
        br: { attributes: [], styles: [], isEmpty: !0 },
        p: { attributes: [], styles: [], isEmpty: !1 },
      },
      customTags: [],
    },
    l = {
      ...
      quote: { tags: ["blockquote"], label: "Quote" },
      bold: { tags: ["strong"], alias: ["b"], label: "Bold" },
      italic: { tags: ["em"], alias: ["i"], label: "Italic" },
      underline: { tags: ["u"], label: "Underline" },
      strike: {
        tags: ["s"],
        alias: ["del", "strike"],
      ...
      alignLeft: { label: "Align left", command: "justifyLeft" },
      alignCenter: { label: "Align center", command: "justifyCenter" },
      alignRight: { label: "Align right", command: "justifyRight" },
      alignJustify: { label: "Justify", command: "justifyFull" },
      ul: {
        tags: ["ul"],
        extraTags: ["li"],
        styles: ["text-align"],
      ...
      image: {
        ...
        formOptions: {
          size: [
            { label: "None", value: "", criterion: null },
            { label: "100%", value: "100%", criterion: { width: "100%" } },
            { label: "50%", value: "50%", criterion: { width: "50%" } },
            { label: "25%", value: "25%", criterion: { width: "25%" } },
          ],
          position: [
            { label: "None", value: "", criterion: null },
            { label: "Left", value: "left", criterion: { float: "left" } },
            { label: "Center", value: "center", criterion: { margin: "auto" } },
            { label: "Right", value: "right", criterion: { float: "right" } },
          ],
        },
        label: "Image",
      },
      ...
      unlink: { label: "Remove link" },
    },
    s = {},
    c = "wysi-selected",
    u = "wysi-fragment-placeholder",
    d = ["H1", "H2", "H3", "H4"],
    p = ["BLOCKQUOTE", "HR", "P", "OL", "UL"].concat(d),
    f = navigator.userAgent.search(/Gecko\//) > -1,
    m = function (e, t) {
      return e.dispatchEvent(new Event(t, { bubbles: !0 }));
    },
    h = function (e, a) {
      return (void 0 === a && (a = null), t.execCommand(e, !1, a));
    },
    v = function (e, t) {
  ...
  function b(e, t, a, i) {
    "string" == typeof a
      ? e.addEventListener(t, function (e) {
          var t = e.target;
          t.matches(a) && i.call(t, e);
        })
      : ((i = a), e.addEventListener(t, i));
  }
  function y(e) {
    var t = w("template");
  ...
  function w(e, a) {
    ...
    if (a)
      for (var n in a)
        "_" === n[0] ? (i[n.substring(1)] = a[n]) : i.setAttribute(n, a[n]);
    return i;
  }
  function x(e, a) {
    ((a = void 0 !== a ? a : []),
  ...
  function A(e) {
    ...
    return { toolbar: i, editor: n, nodes: r };
  }
  function E(e) {
    return e.dataset.wid;
  }
  function H(e) {
  ...
  function N(e) {
    ...
    if (
      ("LABEL" === i.nodeName
        ? (a = i)
        : void 0 !== n && (a = t.querySelector('label[for="' + n + '"]')),
      a)
    ) {
      var r = [].filter
        .call(a.childNodes, function (e) {
          return 3 === e.nodeType;
        })
        .map(function (e) {
          ...
          switch (e) {
            ...
            case "image":
              ...
              ("" !== u && o.push("width: " + u + ";"),
                "" !== d &&
                  ("center" === d
                    ? o.push("display: block; margin: auto;")
                    : o.push("float: " + d + ";")));
              var f =
                  '<img src="' +
                  l +
                  ...
                  c +
                  '" class="wysi-selected"' +
                  (o.length > 0 ? ' style="' + o.join(" ") + '"' : "") +
                  ">",
                m = p ? p.replace(/<img[^>]+>/i, f) : f;
              h("insertHTML", m);
              break;
            default:
              h(e);
  ...
  function q(e) {
    var t = e.label,
      ...
      i = a[0],
      n = w("div", {
        class: ["wysi-listbox"].concat(e.classes || []).join(" "),
      }),
      r = w("button", {
        type: "button",
        title: t,
      ...
      o = w("div", { role: "listbox", tabindex: -1, "aria-label": t });
    return (
  ...
  function B(e) {
    return e.icon
      ? '<svg><use href="#wysi-' + e.icon + '"></use></svg>'
      : e.label;
  }
  function O(e) {
    var t = "true" === e.getAttribute("aria-expanded"),
      a = e.nextElementSibling,
      i = a.querySelector('[aria-selected="true"]');
    (i || (i = a.firstElementChild), T(e, !t), i.focus());
  }
  function I(e) {
    var t = e.parentNode,
      a = t.previousElementSibling,
      i = t.querySelector('[aria-selected="true"]');
    (i && i.setAttribute("aria-selected", "false"),
      e.setAttribute("aria-selected", "true"),
      (a.innerHTML = e.innerHTML));
  }
  function R() {
    var e = t.querySelector('.wysi-listbox [aria-expanded="true"]');
    e && T(e, !1);
  }
  (void 0 !== NodeList &&
    NodeList.prototype &&
    ...
    b(t, "click", ".wysi-listbox > button", function (e) {
      (R(), O(e.target));
    }),
    b(t, "keydown", ".wysi-listbox > button", function (e) {
      switch (e.key) {
        case "ArrowUp":
        case "ArrowDown":
        case "Enter":
        case " ":
          (O(e.target), e.preventDefault());
      }
    }),
    b(
      t.documentElement,
    ...
    b(t, "click", ".wysi-listbox > div > button", function (e) {
      var a = e.target,
        i = a.dataset.action,
        n = a.dataset.option,
        r = A(a).editor,
        o = t.getSelection();
      (o && r.contains(o.anchorNode) && M(i, r, [n]), I(a));
    }),
    b(t, "keydown", ".wysi-listbox > div > button", function (e) {
      var t = e.target,
        a = t.parentNode,
      ...
      switch (e.key) {
        ...
        case "ArrowDown":
          ...
          break;
        case "Home":
          a.firstElementChild.focus();
          break;
        case "End":
          a.lastElementChild.focus();
          break;
        case "Tab":
          t.click();
          break;
      ...
      n && (e.preventDefault(), e.stopImmediatePropagation());
    }));
  var j = !1;
  (b(t, "click", function (e) {
    j || R();
  }),
    b(t, "mousedown", ".wysi-listbox > button", function (e) {
      return (j = !0);
    }),
    b(t, "mouseup", function (e) {
  ...
  function V(e) {
    var t = D++,
      a = w("fieldset", { class: "wysi-segmented" });
    return (
      a.appendChild(w("legend", { _textContent: e.label })),
      e.options.forEach(function (i) {
        var n = D++;
        (a.appendChild(
          w("input", {
            id: "wysi-seg-" + n,
            name: "wysi-" + e.toolName + "-" + e.name + "-" + t,
            type: "radio",
            "data-attribute": e.name,
            value: i.value,
          }),
        ),
          a.appendChild(
            w("label", {
              for: "wysi-seg-" + n,
              _textContent: k(e.toolName, i.label),
            }),
          ));
      }),
      a
  ...
  function Z(e) {
    var a = e.nextElementSibling.querySelectorAll('input[type="text"]'),
      n = e.nextElementSibling.querySelectorAll('input[type="radio"]'),
      r = t.getSelection(),
      o = r.anchorNode,
      s = A(o),
      u = s.editor,
    ...
    if (u) {
      ...
      if (
        (h ||
          ((h = d.filter(function (e) {
            return m.tags.includes(e.tagName.toLowerCase());
          })[0]),
          (v = !0)),
        h)
      ) {
        var b = t.createRange();
        (v ? b.selectNodeContents(h) : b.selectNode(h),
          S(b),
          m.attributes.forEach(function (e) {
            p[e] = h.getAttribute(e);
          }),
          m.extraSettings &&
            m.extraSettings.forEach(function (e) {
              for (var t, a = i(m.formOptions[e]); !(t = a()).done; ) {
                var n = t.value;
                if (n.criterion) {
                  var r = Object.keys(n.criterion)[0],
                    o = n.criterion[r];
                  if (h.style[r] && h.style[r] === o) {
                    p[e] = n.value;
                    break;
                  }
                }
      ...
      } else r && u.contains(o) && r.rangeCount && S(r.getRangeAt(0));
    }
    (a.forEach(function (e) {
      e.value = p[e.dataset.attribute] || "";
    }),
      n.forEach(function (e) {
        var t = p[e.dataset.attribute] || "";
  ...
  function _(e) {
    var t,
      ...
      i = e.dataset.action,
      r = n,
      o = e.parentNode.querySelectorAll('input[type="text"]'),
      l = e.parentNode.querySelectorAll('input[type="radio"]'),
      s = A(e).editor,
      u = [];
    if (
      ...
      l.forEach(function (e) {
        e.checked && u.push(e.value);
      }),
      "image" === i)
    ) {
      var d = s.querySelector("." + c),
        p = d ? d.parentNode : {};
      d && "A" === p.tagName && u.push(p.outerHTML);
    } else
      "link" === i &&
        r &&
        u.push(
          ((t = r.cloneContents()), (a = w("div")).appendChild(t), a.innerHTML),
        );
    M(i, s, u);
  }
  function U(e) {
    var a = t.querySelector('.wysi-popover [aria-expanded="true"]');
    (a && T(a, !1), e || L());
  }
  (b(t, "click", ".wysi-popover > button", function (e) {
    (U(), Z(e.target));
  }),
    b(t, "keydown", ".wysi-popover > button", function (e) {
      switch (e.key) {
        case "ArrowUp":
        case "ArrowDown":
        case "Enter":
        case " ":
          (Z(e.target), e.preventDefault());
      }
    }),
    b(t, "click", ".wysi-popover > div > button[data-action]", function (e) {
      (_(e.target), U(!0));
    }),
    b(
      t,
      "click",
      ".wysi-popover > div > button:not([data-action])",
      function (e) {
        U();
      },
    ),
    b(t, "click", ".wysi-popover *:not(button)", function (e) {
      e.stopImmediatePropagation();
    }),
    b(t, "keydown", ".wysi-popover *", function (e) {
      var t = e.target,
        a = t.parentNode,
        i = "DIV" === a.tagName ? a : a.parentNode;
      switch (e.key) {
        case "Tab":
          var n = i.querySelector("input");
          e.shiftKey
            ? t === n && (i.lastElementChild.focus(), e.preventDefault())
        ...
        case "Enter":
          if ("INPUT" === t.tagName)
            (i.querySelector("[data-action]:last-of-type").click(),
              e.preventDefault());
          break;
        case "Escape":
  ...
  var P = !1;
  function F(e) {
    var t = w("div", { class: "wysi-toolbar" });
    return (
      e.forEach(function (e) {
        switch (e) {
          case "|":
            t.appendChild(w("div", { class: "wysi-separator" }));
            break;
          case "-":
            t.appendChild(w("div", { class: "wysi-newline" }));
            break;
          case "format":
            t.appendChild(
              (function () {
                var e = "format",
                  t = k(e, l.format.label),
                  a = k(e, l.format.paragraph),
                  i = k(e, l.format.heading),
                  n = "wysi-format",
                  r = l.format.tags.map(function (e) {
                    return {
                      name: e,
                      label: "p" === e ? a : i + " " + e.substring(1),
                      action: "format",
                    };
                  });
                return q({ label: t, items: r, classes: n });
              })(),
            );
            break;
          default:
            "object" == typeof e
              ? e.items &&
                t.appendChild(
                  ((i = (a = e).label || k("toolbar", "Select an item")),
                  (n = a.items.map(function (e) {
                    return { label: k(e, l[e].label), icon: e, action: e };
                  })),
                  q({ label: i, items: n })),
                )
              : (function (e, t) {
                  var a = l[e],
                    ...
                    n = w("button", {
                      ...
                      "data-action": e,
                      _innerHTML:
                        '<svg><use href="#wysi-' + e + '"></use></svg>',
                    });
                  if (a.hasForm) {
                    var r = (function (e, t) {
                      var a = l[e],
                        i = a.attributeLabels,
                        n = a.attributes.map(function (t, a) {
                          return { name: t, label: k(e, i[a]) };
                        }),
                        r = w("div", { class: "wysi-popover" }),
                        o = w("div", { tabindex: -1 });
                      if (
                        ...
                        n.forEach(function (t) {
                          if ("link" !== e || "target" !== t.name) {
                            var a = w("label"),
                              i = w("span", { _textContent: t.label }),
                              n = w("input", {
                                type: "text",
                                name: "wysi-" + t.name,
                        ...
                        s &&
                          ((s.toolName = e),
                          (s.options =
                            (a.formOptions && a.formOptions.target) || []),
                          o.appendChild(w("span", { _textContent: s.label })),
                          o.appendChild(V(s)));
                        var c = "unlink",
                          u = k(e, l[c].label);
                        o.appendChild(
                      ...
                      "image" === e &&
                        a.extraSettings
                          .map(function (t, i) {
                            return {
                              name: t,
                              label: k(e, a.extraSettingLabels[i]),
                            };
                          })
                          .forEach(function (t) {
                            ((t.toolName = e),
                              (t.options =
                                (a.formOptions && a.formOptions[t.name]) || []),
                              o.appendChild(
                                w("span", { _textContent: t.label }),
                              ),
                              o.appendChild(V(t)));
                          });
                      var d = w("button", {
                          type: "button",
                          _textContent: k("popover", "Cancel"),
                        }),
                        p = w("button", {
                          type: "button",
                          "data-action": e,
                          _textContent: k("popover", "Save"),
                        });
                      return (o.appendChild(d), o.appendChild(p), r);
                    })(e, n);
                    t.appendChild(r);
  ...
  function J() {
    ...
    if (a) {
      var i = e.getRangeAt(0),
        n = (function (e) {
          for (; null !== e.firstChild; ) e = e.firstChild;
          return e;
        })(i.startContainer.nextElementSibling || i.startContainer),
        r = A(i.intersectsNode(n) ? n : a),
        o = r.toolbar,
        l = r.editor,
        u = r.nodes,
        d = u.map(function (e) {
      ...
      if (l) {
        var p = l.querySelector("." + c);
        p && d.push(p.tagName.toLowerCase());
        var f = E(l),
          m = s[f].allowedTags;
        (o.querySelectorAll('[aria-pressed="true"]').forEach(function (e) {
            ...
            switch (e) {
              ...
              case "li":
                var a = o.querySelector(
                    '[data-action="format"][data-option="' + e + '"]',
                  ),
                  i = u[t].style.textAlign || u[t].getAttribute("align");
                if ((a && I(a), i)) {
                  var n = "align" + i.charAt(0).toUpperCase() + i.slice(1),
                    r = o.querySelector('[data-action="' + n + '"]');
                  r &&
                    ("listbox" === r.parentNode.getAttribute("role")
                      ? I(r)
              ...
              default:
                var l = m[e],
                  s = l ? l.toolName : void 0;
                if (s)
                  o.querySelector('[data-action="' + s + '"]').setAttribute(
                    "aria-pressed",
                    "true",
                  );
            }
  ...
  (b(t, "click", function (e) {
    ...
    b(t, "mousedown", ".wysi-popover, .wysi-popover *", function (e) {
      P = !0;
    }),
    b(t, "mouseup", function (e) {
      setTimeout(function () {
      ...
      a ||
        (!(function (e) {
          ...
          t.forEach(function (e) {
            if (3 !== e.nodeType && p.includes(e.tagName)) a = !1;
            else if (a) {
  ...
  function Q(e, t, a) {
    var i = w(t),
      n = e.parentNode,
      r = e.attributes;
    if (((i.innerHTML = e.innerHTML || e.textContent || e.outerHTML), a && r))
      for (var o = 0; o < r.length; o++) i.setAttribute(r[o].name, r[o].value);
    n.replaceChild(i, e);
  }
  function $(e, t) {
    var a = e.getAttribute(G);
    if (a) {
      var i = a
        .split(";")
        .map(function (e) {
          var t = e.split(":");
          return { name: t[0].trim(), value: t[1] };
        })
        .filter(function (e) {
          return t.includes(e.name);
        })
        .filter(function (e) {
          return "text-align" !== e.name || "left" !== e.value.trim();
        })
        .map(function (e) {
          return e.name + ": " + e.value.trim() + ";";
        })
        .join("");
      "" !== i ? e.setAttribute(G, i) : e.removeAttribute(G);
    }
  }
  function X(e, t) {
    ...
    a &&
      ...
      a.forEach(function (a) {
        if (1 === a.nodeType) {
          ...
          if (r) {
            for (
              var s = r.attributes || [], c = r.styles || [], u = 0;
              u < o.length;
              u++
            ) {
              var d = o[u].name;
              s.includes(o[u].name) ||
                (d === W && "left" !== l && (a.style.textAlign = l),
                d === G && c.length ? $(a, c) : a.removeAttribute(o[u].name));
            }
            r.alias && Q(a, r.alias, !0);
          } else if ("style" === n) e.removeChild(a);
          else {
            if (null !== l)
              if (a.parentNode && "LI" === a.parentNode.tagName)
                a.parentNode.style.textAlign = l;
              else
                for (var p, f = i(a.childNodes); !(p = f()).done; ) {
                  p.value.style.textAlign = l;
                }
            a.replaceWith.apply(a, a.childNodes);
          }
        } else 8 === a.nodeType && e.removeChild(a);
      });
  }
  function Y(e, t) {
    var a = Array.from(e.childNodes);
    a &&
      ...
      a.forEach(function (a) {
        if (1 === a.nodeType) {
          ...
          n &&
            !n.isEmpty &&
            "" === a.innerHTML.replace(/^\s+|\s+$/g, "").trim() &&
            e.removeChild(a);
        }
      });
  }
  var ee = 0;
  function te(t) {
    var a = e.wysiGlobalTranslations || {};
    !(function (e) {
      r = e;
    })(Object.assign({}, a, t.translations || {}));
    var i = t.tools || o.tools,
      n = H(t.el || o.el),
      c = F(i),
      u = (function (e) {
        var t = g(o.allowedTags);
        return (
          e.forEach(function (e) {
            var a = g(l[e]);
            if (a && a.tags) {
              var i = !!a.isEmpty,
                n = a.extraTags || [],
                r = a.alias || [],
                o = r.length ? a.tags[0] : void 0,
                s = [].concat(a.tags, n, r),
                c = a.attributes || [],
                u = a.styles || [];
              s.forEach(function (a) {
                ((t[a] = { attributes: c, styles: u, alias: o, isEmpty: i }),
                  n.includes(a) || (t[a].toolName = e));
              });
            }
          }),
          t
    ...
    ((t.customTags || []).forEach(function (e) {
      if (e.tags) {
        var t = e.attributes || [],
          a = e.styles || [],
          i = !!e.isEmpty;
        e.tags.forEach(function (e) {
          u[e] = { attributes: t, styles: a, isEmpty: i };
        });
      }
    }),
      n.forEach(function (e) {
        var a = e.previousElementSibling;
        if (a && v(a, "wysi-wrapper")) ae(a, t);
        else {
          var i = ee++;
          ((s[i] = t), (s[i].allowedTags = g(u)));
          var n = w("div", { class: "wysi-wrapper" }),
            r = w("div", {
              class: "wysi-editor",
              contenteditable: !0,
              role: "textbox",
    ...
    if ("object" == typeof t)
      for (var a in t)
        switch (a) {
          ...
          case "autoGrow":
          case "autoHide":
            e.classList.toggle("wysi-" + a.toLowerCase(), !!t[a]);
            break;
          case "height":
            var i = t.height;
            if (!isNaN(i)) {
              var n = e.lastChild;
              ((n.style.minHeight = i + "px"), (n.style.maxHeight = i + "px"));
            }
        }
  }
  function ie(e, t, a, i, n) {
    var r = s[a],
      o = K(i, r.allowedTags),
      l = r.onChange;
    (!0 === n && (t.innerHTML = o), (e.value = o), m(e, "change"), l && l(o));
  }
  function ne(e) {
    for (var t, a = i(C(e)); !(t = a()).done; ) {
      var n = t.value,
        r = n.instanceId,
        o = n.wrapper;
      (delete s[r], o.remove());
  ...
  function re(e, t) {
    for (var a, n = i(C(e)); !(a = n()).done; ) {
      var r = a.value;
      ie(r.textarea, r.editor, r.instanceId, t, !0);
    }
  }
  function oe(e) {
    var t = A(e.target),
      ...
      i = t.nodes,
      n = e.clipboardData;
    if (a && n.types.includes("text/html")) {
      var r = n.getData("text/html"),
        o = E(a),
        l = K(r, s[o].allowedTags),
        c =
          i.filter(function (e) {
            return d.includes(e.tagName);
          }).length > 0;
      if (c && !f) {
        var m = '<h1 class="' + u + '"><br></h1><p class="' + u + '"><br></p>';
        l = m + l + m;
      }
      (h("insertHTML", l),
        c &&
          !f &&
          (a.querySelectorAll("." + u).forEach(function (e) {
            e.remove();
          }),
          a.querySelectorAll(d.join()).forEach(function (e) {
            var t = e.firstElementChild;
            t && p.includes(t.tagName) && e.replaceWith.apply(e, e.childNodes);
          })),
        e.preventDefault());
    }
  }
  ((e.Wysi = (function () {
    var e = { destroy: ne, setContent: re };
    function t(e) {
      x(function () {
        te(e || {});
      });
    ...
    x(function () {
      (h("styleWithCSS", !1),
        h("enableObjectResizing", !1),
        h("enableInlineTableEditing", !1),
        h("defaultParagraphSeparator", "p"),
        b(t, "input", ".wysi-editor", function (e) {
          var t = e.target;
          ie(t.parentNode.nextElementSibling, t, E(t), t.innerHTML);
        }),
        b(t, "paste", oe));
    }));
})(window, document);
